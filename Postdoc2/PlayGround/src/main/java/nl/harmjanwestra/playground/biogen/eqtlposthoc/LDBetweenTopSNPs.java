...
public class LDBetweenTopSNPs {
    ...
    public static void main(String[] args) {
        ...
        eqtlfile1 = "D:\\Sync\\SyncThing\\Postdoc2\\2019-BioGen\\data\\2020-01-Freeze2dot1\\2020-02-18-eqtls\\cis-cortex-eurandafr-iterative\\Iteration1-eQTLProbesFDR0.05-ProbeLevel.txt.gz";
        eqtlfile1 = "D:\\Sync\\SyncThing\\Postdoc2\\2019-BioGen\\data\\2020-01-Freeze2dot1\\2020-02-18-eqtls\\cis-cortex-eur\\eQTLDump-sortZ-FDR.txt.gz-Significant-0.05-topfx.txt.gz";
        eqtlfile2 = "D:\\Sync\\SyncThing\\Postdoc2\\2019-BioGen\\data\\2020-01-Freeze2dot1\\eqtlgen\\2019-12-11-cis-eQTLProbesFDR0.05-ProbeLevel-MetaBrain2dot1IDsandPos.txt.gz";
        output = "D:\\Sync\\SyncThing\\Postdoc2\\2019-BioGen\\data\\2020-01-Freeze2dot1\\2020-02-18-eqtls\\cis-cortex-ldwitheqtlgen\\MetaBrainEURvsEQTLgen.txt";
        ...
        for (String gene : eqtlset1.keySet()) {
            ...
            if (e2 != null) {
                ...
                if (e1.snppos == e2.snppos) {
                    ...
                    if (e1.chr == e2.chr && e1.snppos > 0 && e2.snppos > 0 && e1.chr > 0 && e2.chr > 0 && e1.chr < 22 && e2.chr < 22) {
                        // check LD
    ...
    private HashMap<String, EQTL> loadEQTLs(String eqtlfile1) throws IOException {
        ...
        while (elems != null) {
            ...
            int pos = -1;
            try {
                pos = Integer.parseInt(elems[3]);
                chr = Integer.parseInt(elems[2]);
            ...
            try {
                beta = Double.parseDouble(betastrelems[0]);
                se = Double.parseDouble(betastrelems[1].replaceAll("\\)", "").replaceAll("\\(", ""));
            } catch (NumberFormatException e) {
