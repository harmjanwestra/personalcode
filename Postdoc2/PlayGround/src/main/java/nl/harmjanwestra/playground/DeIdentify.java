...
//		FastaSequenceFile fastaFile = new FastaSequenceFile(new File(fasta), false);
...
//
//		SAMFileReader reader = SamReaderFactory.make().enable(new SamReaderFactory.Option[]{SamReaderFactory.Option.CACHE_FILE_BASED_INDEXES}).validationStringency(SAMFileReader.ValidationStringency.DEFAULT_STRINGENCY).open(new File(bamFile));
