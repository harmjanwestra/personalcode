...
//            fdr.tssdistance(files2, eqtlgenannot, metabrainannot, "D:\\Sync\\Syncthing\\Temp\\Psychencode\\significanteqtls-replineqtlgen-GTEXv7-tssdist-brainForPsychencode.pdf");
...
//			};
			...
			fdr.tssdistancePerFDRBin(files2, eqtlgenannot, metabrainannot, "D:\\Sync\\Syncthing\\Temp\\Psychencode\\significanteqtls-replineqtlgen-GTEXv7-tssdist-brainForPsychencode-perFDRBin.pdf");
...
//				double pvalnomthreshold = Double.parseDouble(elems[pvalthresholdcol]);
        ...
        Grid g = new Grid(500, 200, (files.length / 2) + 1, 2, 200, 200);
        for (int i = 0; i < files.length; i++) {
...
//			p.setDataRange(new Range(0, -1000000, dists.size(), 1000000));
            ...
            p.setAlpha(0.2f);
            p.setLabels("eQTL rank (based on significance)", "TSS Distance");
