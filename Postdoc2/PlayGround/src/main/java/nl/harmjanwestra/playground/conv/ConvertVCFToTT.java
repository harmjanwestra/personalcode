...
public class ConvertVCFToTT {
    ...
    public void run(String vcffile, String output, boolean parseVCF, boolean writegenotypes,
                    ...
                    HashSet<String> allowedVQSROrINFO, double inbreedingCoeff, double impqualthreshold) throws IOException {
        ...
        File imputedDosageDataFile2 = new File(folder, "ImputedDosageMatrixV2.dat");
        File snpFile = new File(folder, "SNPs.txt.gz");
        File snpFile2 = new File(folder, "SNPsV2.txt.gz");
...
//							}
    ...
    public void ConvertWithoutFilter(String vcffile, String output, double mafthreshold, double missingnessthreshold, HashSet<String> allowedVQSROrINFO) throws IOException {
        System.out.println("in: " + vcffile);
        System.out.println("out: " + output);
        System.out.println("maf: " + mafthreshold);
